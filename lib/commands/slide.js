...
slide._layers = function () {
    var layerOptions = require('../../assets/src/parari.js/.layer-options');
    return Object.keys(layerOptions).map(function(name){
        return {
            name:name,
            options:layerOptions[name]
        }
    });
};
